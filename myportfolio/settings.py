...
SECRET_KEY = 'django-insecure-ac=_pq56l4%41kw-e42%+r%-fmoz96p&#5%&d_hvt@u0nybtue'
...
#Esto te permitirá luego subir imágenes y usar CSS/JS en tu portafolio.
STATIC_URL = '/static/'
...
# Si usas whitenoise (ya recomendado), añade:
